...
CREATE TABLE `delivery_note_items` (
  ...
  KEY `item_id` (`item_id`),
  CONSTRAINT `delivery_note_items_ibfk_1` FOREIGN KEY (`delivery_id`) REFERENCES `delivery_notes` (`id`),
  CONSTRAINT `delivery_note_items_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`)
...
INSERT INTO `delivery_note_items` VALUES (1,1,2,3.00),(2,1,3,3.00);
