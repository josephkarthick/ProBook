...
CREATE TABLE `delivery_notes` (
  ...
  CONSTRAINT `delivery_notes_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
  CONSTRAINT `delivery_notes_ibfk_2` FOREIGN KEY (`sales_order_id`) REFERENCES `sales_orders` (`id`)
...
INSERT INTO `delivery_notes` VALUES (1,1,6,'DN-00001','2026-03-26','POSTED'),(2,1,6,'DN-00002','2026-03-26','POSTED');
