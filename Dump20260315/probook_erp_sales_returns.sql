...
CREATE TABLE `sales_returns` (
  ...
  `return_no` varchar(20) DEFAULT NULL,
  ...
  CONSTRAINT `sales_returns_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
  CONSTRAINT `sales_returns_ibfk_2` FOREIGN KEY (`invoice_id`) REFERENCES `sales_invoices` (`id`)
